  ...
  return (
    <div className="min-h-screen flex items-center justify-between bg-[linear-gradient(90deg,#000000,#1584bb)] overflow-hidden">
      <div className="flex flex-col gap-5 ml-50">
        ...
        <div className="flex">
          <p className="text-white text-3xl" style={{ fontFamily: "var(--font-dm-sans)" }}>ALL CATEGORIES</p>
          <img src="/images/arrowtriple.png" alt="" className="w-20 h-10 object-contain"/>
        </div>
        <div className="h-[2px] w-75 opacity-50 bg-white"></div>
        <div className="flex bg-[linear-gradient(135deg,#a6a6a6,#ffffff)] w-70 rounded-2xl h-30 p-2 pl-4 mt-15">
          <div className="flex flex-col gap-13">
            <p className="text-white" style={{ fontFamily: "var(--font-robot)" }}>NEW ARRIVALS</p>
            <button className="bg-subtext text-sm text-white w-28 rounded-full" style={{ fontFamily: "var(--font-robot)" }}>VIEW MORE</button>
          </div>
          <img src="" alt="" />
        </div>
      </div>
      ...
      <div className="relative w-100 flex justify-end items-center h-screen">
        ...
        <div className="absolute w-100 h-100 flex items-center justify-center mt-60 border-2 border-amber-400">
          <FerrisWheel />
        </div>
      </div>
    </div>
